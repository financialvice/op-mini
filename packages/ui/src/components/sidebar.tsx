...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    (value: boolean | ((internalValue: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn/ui uses document.cookie
  ...
  const toggleSidebar = useCallback(
    () =>
      isMobile
        ? setOpenMobile((internalOpenMobile) => !internalOpenMobile)
        : setOpen((internalOpen) => !internalOpen),
    [isMobile, setOpen]
  );
